...
func (_m *APIClient) ImageList(ctx context.Context, options types.ImageListOptions) ([]image.Summary, error) {
	ret := _m.Called(ctx, options)
...
func (_m *APIClient) ImageRemove(ctx context.Context, _a1 string, options types.ImageRemoveOptions) ([]image.DeleteResponse, error) {
	ret := _m.Called(ctx, _a1, options)
