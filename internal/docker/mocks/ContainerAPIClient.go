...
func (_m *ContainerAPIClient) ContainerExecCreate(ctx context.Context, _a1 string, config container.ExecOptions) (types.IDResponse, error) {
...
func (_m *ContainerAPIClient) ContainerList(ctx context.Context, options container.ListOptions) ([]types.Container, error) {
