...
func (_m *ImageAPIClient) ImageList(ctx context.Context, options types.ImageListOptions) ([]image.Summary, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.ImageListOptions) ([]image.Summary, error)); ok {
		return rf(ctx, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.ImageListOptions) []image.Summary); ok {
		r0 = rf(ctx, options)
	} else {
		if ret.Get(0) != nil {
...
func (_m *ImageAPIClient) ImageRemove(ctx context.Context, _a1 string, options types.ImageRemoveOptions) ([]image.DeleteResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, types.ImageRemoveOptions) ([]image.DeleteResponse, error)); ok {
		return rf(ctx, _a1, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, types.ImageRemoveOptions) []image.DeleteResponse); ok {
